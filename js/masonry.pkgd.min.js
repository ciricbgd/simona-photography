$(document).ready(function () {
    ...
    function (t, e) {
        ...
        function o(o) {
            if (n(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
                ...
                for (var d = u.isBorderBox = "border-box" == s.boxSizing, c = 0; h > c; c++) {
                    var l = a[c],
                        f = s[l],
                        m = parseFloat(f);
                    u[l] = isNaN(m) ? 0 : m
                ...
                var p = u.paddingLeft + u.paddingRight,
                    ...
                    E = u.borderLeftWidth + u.borderRightWidth,
                    _ = u.borderTopWidth + u.borderBottomWidth,
                    b = d && r,
                    I = t(s.width);
                !1 !== I && (u.width = I + (b ? 0 : p + E));
                var z = t(s.height);
                return !1 !== z && (u.height = z + (b ? 0 : g + _)), u.innerWidth = u.width - (p + E), u.innerHeight = u.height - (g + _), u.outerWidth = u.width + y, u.outerHeight = u.height + v, u
            }
        }
    ...
    function (t, e) {
        ...
        return n._resetLayout = function () {
            ...
            for (var o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, t), r = {
                    ...
                    y: o.y
                }, s = o.y + t.size.outerHeight, a = n + o.col, h = o.col; a > h; h++) this.colYs[h] = s;
            return r
            ...
            for (var h = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, u = s; a >= u; u++) this.colYs[u] = Math.max(h, this.colYs[u])
    ...
    function (t, e) {
        ...
        function o(t, e, r) {
            ...
            var s = t;
            "string" == typeof t && (s = document.querySelectorAll(t)), s ? (this.elements = n(s), this.options = i({}, this.options), "function" == typeof e ? r = e : i(this.options, e), r && this.on("always", r), this.getImages(), a && (this.jqDeferred = new a.Deferred), setTimeout(this.check.bind(this))) : h.error("Bad element for imagesLoaded " + (s || t))
        }
